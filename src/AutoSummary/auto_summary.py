...
import codecs
import sys
# from . import TextRank4Keyword, TextRank4Sentence
from src.AutoSummary import TextRank4Keyword, TextRank4Sentence

# zhaiyao_num = int(sys.argv[1])
zhaiyao_num = 1
text = codecs.open('/mnt/project/NLPandNLG/nlg/data/20200201_01_03', 'r', 'utf-8').read()
tr4s = TextRank4Sentence(stop_words_file='/mnt/project/NLPandNLG/nlg/data/stopwords.txt', decay_rate=1.0)  # 导入停止词
