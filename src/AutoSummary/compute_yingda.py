...
model = gensim.models.Word2Vec.load(os.path.join(d, "/mnt/project/NLPandNLG/nlg/data/all_data_word2vec.model"))
...
def chuli(pi):
    ...
    with open(os.path.join(d, "/mnt/project/NLPandNLG/nlg/data/non_words.txt")) as readme:
        for line in readme:
